      ...
      <InforPart type="personal">
        ...
        <div className="ms-2">
          <FlexInput
            ...
            iconLeft={<IoCalendarClear className="mb-1 text-muted" />}
          ...
          <FlexInput
            className="ms-5 w-75"
            innerClassName={clsx('content', bgColor)}
            iconLeft={<FaPhoneAlt className="mb-1 text-muted" />}
          ...
          <FlexInput
            className="ms-5 w-75"
            innerClassName={clsx('content', bgColor)}
            iconLeft={<IoMdMail className="mb-1 text-muted" />}
            placeholder="Email"
          ...
          <FlexInput
            className="ms-5 w-75"
            innerClassName={clsx('content', bgColor)}
            iconLeft={<IoIosLink className="mb-1 text-muted" />}
            placeholder="Liên kết"
          ...
          <FlexInput
            className="ms-5 w-75"
            innerClassName={clsx('content', bgColor)}
            iconLeft={<MdLocationOn className="fs-5 mb-1 text-muted" />}
            placeholder="Địa chỉ"
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div
          ...
          style={{ width: '800px' }}
        >
          <div style={{ width: '45%' }} className="ps-1 pe-2 position-relative">
