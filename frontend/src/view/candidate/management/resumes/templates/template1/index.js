  ...
  const PersonalPart = ({ bgColor }) => {
    return (
      <InforPart type="personal">
        <FlexInput
          innerClassName={clsx('title d-none', bgColor)}
        ...
        <div className="d-flex ms-2 w-100">
          <div className="w-100">
            <FlexInput
              ...
              iconLeft={<IoCalendarClear className="mb-1 text-warning" />}
            ...
            <FlexInput
              className="align-items-center mt-2"
              innerClassName={clsx('content', bgColor)}
              iconLeft={<FaPhoneAlt className="mb-1 text-warning" />}
            ...
            <FlexInput
              className="align-items-center mt-2"
              innerClassName={clsx('content', bgColor)}
              iconLeft={<IoMdMail className="mb-1 text-warning" />}
              placeholder="Email"
          ...
          <div className="w-100">
            <FlexInput
              className="align-items-center mt-2"
              innerClassName={clsx('content', bgColor)}
              iconLeft={<IoIosLink className="mb-1 text-warning" />}
              placeholder="Liên kết"
            ...
            <FlexInput
              className="align-items-center mt-2"
              innerClassName={clsx('content', bgColor)}
              iconLeft={<MdLocationOn className="fs-5 mb-1 text-warning" />}
              placeholder="Địa chỉ"
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div
          ...
          style={{ width: '800px' }}
        >
          <div className="cv-bg-main ps-1 pe-2 w-100">
            <div className="mt-2 d-flex align-items-start gap-2 p-2 bg-secondary border">
              <img
              ...
              <div className="w-100">
                <FlexInput
                  placeholder="HỌ TÊN"
                  className="mt-2 mb-2"
                  innerClassName="cv-bg-main cv-text-main text-uppercase"
